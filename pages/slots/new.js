...
export default function SlotsReviewPage({
  ...
  return (
    <>
      <Head>
        <title>New Slots 2023 | TheGamblr.com</title>
        <meta
          name="description"
          content="Check out newly released gambling slots for 2023"
        />
        <meta
          name="keywords"
          content="newly released slots, new slots 2023, new gambling slots"
        />
      </Head>
      <Box sx={{ height: '200px' }} />
      ...
      <Grid container spacing="40px">
        <Grid item xs={3}>
          <ImagePaper
            image={`${IMAGE_URL}page-images/new.webp`}
