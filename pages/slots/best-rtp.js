...
export default function SlotsReviewPage({
  ...
  return (
    <>
      <Head>
        <title>Best RTP Slots 2023 | TheGamblr.com</title>
        <meta name="description" content="Check out BEST RTP Slots for 2023" />
        <meta
          name="keywords"
          content="best rtp slots, high rtp, online gambling slots rtp"
        />
      </Head>
      <Box sx={{ height: '200px' }} />
      ...
      <Grid container spacing="40px">
        <Grid item xs={3}>
          <ImagePaper
            image={`${IMAGE_URL}page-images/best-rtp.webp`}
