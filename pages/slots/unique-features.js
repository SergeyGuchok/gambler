...
export default function SlotsReviewPage({
  ...
  return (
    <>
      <Head>
        <title>Slots With Unique Features 2023 | TheGamblr.com</title>
        <meta
          name="description"
          content="Check out unique features of different gambling slots 2023"
        />
        <meta
          name="keywords"
          content="unique features 2023, slots with unique features"
        />
      </Head>
      <Box sx={{ height: '200px' }} />
      <Typography sx={titleSx} variant="h1">
        Slots With Unique Features
      </Typography>
      <Grid container spacing="40px">
        <Grid item xs={3}>
          <ImagePaper
            image={`${IMAGE_URL}page-images/unique-features-slots.webp`}
